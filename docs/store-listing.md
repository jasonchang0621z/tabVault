...
Save and restore tab workspaces with full tab group support. Keep your projects organized — one click to switch contexts.

## Detailed Description

TabVault lets you save your entire browser window — tabs and tab groups — as a workspace, and restore it anytime with a single click.
